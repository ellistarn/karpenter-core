...
func (p *Provider) Get(ctx context.Context, nodePool *v1beta1.NodePool, optionss ...option.Function[Options]) ([]*cloudprovider.InstanceType, error) {
	optionss = append(optionss, ConsistentRead) // TODO remove this when we wire up the instance type controller
	options := option.Resolve(optionss...)
